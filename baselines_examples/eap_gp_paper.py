...
def parse_args():
    ...
    p.add_argument("--dataset-path", default="data/data/datasets/gp/")
    ...
    p.add_argument("--out-dir", default="results/gp-eap-paper-kl")
    return p.parse_args()
...
def get_gp_data(ds, tokenizer, max_examples):
    ...
    for i in range(len(clean_texts)):
        ...
        pred_indices.append(last_real_pos - 1)
...
def main():
    ...
    train_toks, train_corr_toks, train_idx, train_correct, train_distractor = get_gp_data(
    ...
    eval_toks, eval_corr_toks, eval_idx, eval_correct, eval_distractor = get_gp_data(
    ...
    csv_path = os.path.join(args.out_dir, f"eap_gp_{args.eval_split}_metrics.csv")
