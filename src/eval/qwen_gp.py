...
def main():
    ...
    model = FQwen2LMHeadModel.from_pretrained(args.model_name_or_path, with_embedding_nodes=args.with_embedding_nodes).to(args.device)
    model.eval()
    tokenizer = AutoTokenizer.from_pretrained("Qwen/Qwen2-0.5B")
    control_model = FQwen2LMHeadModel.from_pretrained("Qwen/Qwen2-0.5B", with_embedding_nodes=args.with_embedding_nodes).to(args.device)
