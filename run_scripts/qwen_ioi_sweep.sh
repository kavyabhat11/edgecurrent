#!/bin/bash
# Edge Pruning sweep on Qwen2-0.5B for IOI.
...
WANDB_MODE=disabled python src/prune/fqwen_ioi.py \
    --report_to wandb \
    --do_train \
    --do_eval \
    ...
    --output_dir ./data/runs/qwen-ioi-${TAG}-es${EDGE_SPARSITY}-ns${NODE_SPARSITY}-t${TOTAL}/ \
